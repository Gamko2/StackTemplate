...
public:
	Stapel() { head = 0; anz = 0; }//NULLpointer wird in C++ einfach mit 0 angegeben
	...
	int get_anz() { return anz; } /* Informiert über die Anzahl der Knoten in der Liste*/
	long back(); /*gibt eine Kopie der Information aus dem obersten Knoten aus ohne den Knoten zu löschen.*/
	bool isEmpty();
